...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference("Temperature.count") do
      post temperatures_url, params: { temperature: { avg_temp: @temperature.avg_temp, city_id: @temperature.city_id, date: @temperature.date } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { avg_temp: @temperature.avg_temp, city_id: @temperature.city_id, date: @temperature.date } }
